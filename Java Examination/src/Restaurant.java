...
import java.util.ArrayList;
    public class Restaurant {  // created class Restaurant
        private ArrayList<String> menuItems;  //Created collection menuItems
        private ArrayList<Double> prices;  //Created collection prices
        private ArrayList<Integer> ratings; //Created collection ratings
        private ArrayList<Integer> itemCounts; //Created collection itemcounts

        public Restaurant() {  //Initialised Restaurant attributes
        ...
        public void addItem(String item, double price) {  //Method to add Restuarant items
        ...
        public void removeItem(String item) {  // method to remove Restuarant items by their indices
        ...
        public double getAverageRating(String item) {
            ...
            if (index >= 0) {
                ...
                return itemCount > 0 ? (double) totalRating / itemCount : 0.0; //Calculating total rating
            } else {
                return 0.0;
            }
        }
